...
class Uklad:
    ...
    def losuj_uklad_symetryczny_dodatnio_okreslony(self, alfa = 0.3):
        """Losowanie ukladu symetrycznego, dodatnio okreslonego
            ...
            - im wieksza wartosc parametru, tym wieksza dominacja"""
        ...
        for i in range(self.n):
            ...
            for j in range(self.n):
                suma += abs(self.A[i, j]) * (1+np.random.random()*alfa)
            self.A[i, i] = suma
        self.B = D.copy()
